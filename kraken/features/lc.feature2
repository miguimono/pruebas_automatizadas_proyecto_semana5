Feature: Posts
    ...
    @user1 @web
    Scenario: As a Ghost user, I want to login and create a Posts
        ...
        Then I enter "post de prueba" into input field having css selector ".gh-editor-title.ember-text-area.gh-input.ember-view"
        Then I click on element having css selector "a.blue.link.fw4.flex.items-center.ember-view"
        Then I should see text "post de prueba"